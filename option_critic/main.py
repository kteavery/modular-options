...
parser.add_argument('--optimal-eps', type=float, default=0.01, help='Epsilon when playing optimally')
...
parser.add_argument('--max-history', type=int, default=50000, help=('Maximum number of steps stored in replay'))
